...
export def generate-matrix-json [
  ...
  let matrix_entries = if $is_multi_platform {
    use ./platforms.nu [expand-version-to-platforms get-default-platform]
...
export def generate-service-matrix [
  ...
  use ./manifest.nu [load-versions-manifest]
...
export def generate-multi-service-matrix [
  ...
  use ./platforms.nu [check-platforms-manifest-exists load-platforms-manifest expand-version-to-platforms get-default-platform]
