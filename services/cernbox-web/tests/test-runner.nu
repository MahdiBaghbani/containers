...
# Test runner for cernbox-web scripts unit tests

def main [
  --suite: string = "all"  # Which test suite to run (all, build-extensions)
  --verbose                 # Show detailed output
] {
  print "Running Cernbox Web Scripts Test Suite\n"

  let test_dir = (try {
    if ("./services/cernbox-web/tests" | path exists) {
      "./services/cernbox-web/tests"
