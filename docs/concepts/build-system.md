...
```yaml
# Generated by: nu scripts/dockypody.nu ci workflow
build_cernbox_revad:
...
The CI workflows are generated from the service dependency graph using the DockyPody CLI. This ensures workflows stay in sync with service configurations.
...
```yaml
# In build-service.yml call (from orchestrator workflow)
uses: ./.github/workflows/build-service.yml
with:
  service: cernbox-web
